            ...
            <div class="items-list-view" v-for="(item, index) in cartItems" :key="item.id">
              <item-list-view :item="item" class="mb-base">
                ...
                <template slot="item-meta">
                  ...
                  <p class="text-sm">Unidades disponibles: <span class="font-semibold">{{0 >= item.stock ? 0 : item.stock}}</span></p>

                  <p class="mt-4 font-bold text-sm">Cantidad</p>
                  <vs-input-number :min="1" :max="item.stock" :value="item.quantity"
                                   @input="updateItemQuantity($event, index, item)" class="inline-flex"/>
      ...
      <tab-content title="Dirección" icon="feather icon-home" class="mb-5">
        ...
        <div class="vx-row">
          ...
          <div class="vx-col lg:w-2/3 w-full">
            <vx-card title="Añadir nueva dirección"
                     subtitle="Asegurate de comprobar que la dirección que estas ingresando es correcta."
                     class="mb-base">
                ...
                <div class="vx-row">
                  <div class="vx-col sm:w-1/2 w-full">
                    ...
                    <vs-input
                      ...
                      v-model="nombre"
                      class="w-full mt-5"/>
                    <span v-show="errors.has('add-new-address.nombre')"
                  ...
                  <div class="vx-col sm:w-1/2 w-full">
                    ...
                    <vs-input
                      ...
                      v-model="telefono"
                      class="w-full mt-5"/>
                    <span v-show="errors.has('add-new-address.telefono')"
                          class="text-danger">Este campo es obligatorio</span>
                  </div>
                ...
                <div class="vx-row">
                  ...
                  <div class="vx-col sm:w-1/2 w-full">
                    ...
                    <vs-input
                      ...
                      v-model="calle"
                      class="w-full mt-5"/>
                    <span v-show="errors.has('add-new-address.calle')"
                          class="text-danger">Este campo es obligatorio</span>
                  </div>
                ...
                <div class="vx-row">
                  ...
                  <div class="vx-col sm:w-1/2 w-full">
                    ...
                    <vs-input
                      ...
                      v-model="ciudad"
                      class="w-full mt-5"/>
                    <span v-show="errors.has('add-new-address.ciudad')"
                          class="text-danger">Este campo es obligatorio</span>
                  </div>
                    ...
                    <div class="flex flex-wrap justify-between items-center" v-if="user">
                      <vs-radio v-model="paymentMethod" vs-value="debit-card">
                        <div class="flex items-center">
                          <img src="@/assets/images/pages/eCommerce/bank.png" alt="bank-logo" height="40" width="50"
                               class="inline-flex">
