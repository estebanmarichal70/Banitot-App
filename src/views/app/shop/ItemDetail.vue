<template>
  <div id="item-detail-page">
    ...
    <vs-alert color="danger" title="Error al cargar el artículo" :active.sync="error_occured">
      <span>{{ error_msg }}. </span>
      <span>
        <span>Ver </span><router-link :to="{name:'ecommerce-shop'}"
                                      class="text-inherit underline">todos los articúlos</router-link>
      </span>
    </vs-alert>
            ...
            <div class="vx-row mt-6">
              ...
              <div class="vx-col md:w-3/5 w-full">
                ...
                <p class="flex items-center flex-wrap">
                  <span
                    class="text-2xl leading-none font-medium text-primary mr-4 mt-2">US$ {{ item_data.precio }}</span>
                  <span
                    class="pl-4 mr-2 mt-2 border border-solid d-theme-border-grey-light border-t-0 border-b-0 border-r-0"><star-rating
                    :show-rating="false" :rating="item_data.rating" :star-size="20" read-only/></span>
                ...
                <vs-list class="product-sales-meta-list px-0 pt-4">
                  <vs-list-item
                    ...
                    icon-pack="feather"
                    icon="icon-truck"/>
                  <vs-list-item class="p-0 border-none" title="Impuestos incluidos" icon-pack="feather"
                ...
                <div class="vx-row">
                  ...
                  <div class="vx-col w-full">
                    <strong><p class="my-2">
                      ...
                      <span class="text-success" v-if="item_data.stock > 0">Disponible</span>
                  ...
                  <div class="vx-col w-full">
                    <div class="flex flex-wrap items-start mb-4">
                      ...
                      <vs-button
                        ...
                        :disabled="0 >= item_data.stock ? true : false">
                        Agregar al carrito
                      </vs-button>
            ...
            <div class="vx-row">
              ...
              <div class="vx-col md:w-1/3 w-full">
                <div class="w-64 mx-auto mb-16 md:mb-0">
                  ...
                  <p class="mt-2">Si no te gustó el producto o presenta fallas, podés cambiarlo en los primeros diez
